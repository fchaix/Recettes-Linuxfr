...
\usepackage{fourier} % Pour le signe \attention (à changer, c'est une police nonfree :-( )

\input{code/constantes}

\input{code/fonctions/lien} % Ça ne marche pas de mettre un *
\input{code/fonctions/moule}
\input{code/fonctions/remarque}
\input{code/fonctions/ingredients}
\input{code/fonctions/instructions}
\input{code/fonctions/Date}
\input{code/fonctions/attention}
